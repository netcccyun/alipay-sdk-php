...
class AlipayTransferService extends AlipayService
{
     ...
     * @param string $biz_scene 业务场景
     * @return mixed
     * @throws Exception
     */
    public function quotaQuery(string $product_code = 'TRANS_ACCOUNT_NO_PWD', string $biz_scene = 'DIRECT_TRANSFER')
    {
        $apiName = 'alipay.fund.quota.query';
        $bizContent = [
